        ...
        <div class="col-sm-12">
          <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
            <div class="carousel-item-b">
              <img src="{{ asset('client/img/slide-2.jpg') }}" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="{{ asset('client/img/slide-3.jpg') }}" alt="">
            </div>
            <div class="carousel-item-b">
              <img src="{{ asset('client/img/slide-1.jpg') }}" alt="">
            </div>
          </div>
        ...
        <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4">
              <img src="{{ asset('client/img/agent-4.jpg') }}" alt="" class="img-fluid">
            </div>
            <div class="col-md-6 col-lg-4">
