            ...
            <form accept="{{ route('property.update', $property) }}" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" id="property_type_id" name="property_type_id">
                            @foreach ($types as $type)
                                <option value="{{ $type->id }}" @if($type->id == $property->property_type_id) selected @endif>{{ $type->type_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="area" name="area" placeholder="Enter area"  value="{{ $property->area }}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="price" name="price" placeholder="Enter price" value="{{ $property->price }}">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-row">
                    <div class="col-md-8">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter email" value="{{ $property->email }}">
                    </div>
                </div>

                <div class="form-row">
                    @foreach ($oldImages as $old)
                        <img class="rounded" style="width: 200px;height: 200px;object-fit:contain" src="{{ asset('storage/'.$old->image_url) }}" alt="">
                    @endforeach
                </div>
